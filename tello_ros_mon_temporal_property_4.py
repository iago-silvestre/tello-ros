...
# property to verify
PROPERTY = "(forall[t]. {topic: 'cmd_velX', time: *t} -> {topic: 'cmd_velX', forwardMotion: 'True', time: *t})"
...
def abstract_message(message):
    ...
    if message['topic'] == 'cmd_velX':
    	speedX = int(message['data'])
    	predicates['forwardMotion'] = str((speedX >= 0))
